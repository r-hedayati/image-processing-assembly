...
RM_msg3			db	new_line,cret," Press 'P' key ",new_line,cret,0
Load_Segment	dw 0x1000	;File will be loaded into 0x10000
Load_Offset		dw 0		;
%define			VIDMEM	0xB8000			; video memory
vector1                 dd      0x00000000
                                dd       0x00000000


vector			dd	0xAAAAAAAA
				dd  	0xAAAAAAAA
...
BadImage db "Welcome to protected mode!",0xA," is it new line", 0
